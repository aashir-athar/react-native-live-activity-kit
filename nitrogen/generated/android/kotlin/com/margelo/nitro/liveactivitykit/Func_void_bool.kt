...
/**
 * Represents the JavaScript callback `(enabled: boolean) => void`.
...
fun interface Func_void_bool: (Boolean) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(enabled: Boolean): Unit
}
...
class Func_void_bool_cxx: Func_void_bool {
  ...
  @FastNative
  private external fun invoke_cxx(enabled: Boolean): Unit
}
